...
class Program(models.Model):
    """
    A program is a set schedule of texts. First send this on this date,
    then X days later send this, then Y days later ...
    """
    id = models.AutoField(primary_key = True)
    name = models.CharField(_("program name"),
        max_length = 255, help_text = "Name of Program")
    n_texts = models.PositiveIntegerField(_("number of texts in program")) 
    runtime_days = models.PositiveIntegerField(_("program runtime in days")) 
...
class ProgramTexts(models.Model):
    """
...
class ProgramParticipantRecord(models.Model):
    """
